...
outputs:
- {id: CLKOUT_clock.outFreq, value: 1 MHz}
- {id: FRO12M_clock.outFreq, value: 12 MHz}
- {id: FROHF_clock.outFreq, value: 48 MHz}
...
settings:
- {id: SYSCON.CLKOUTDIV.scale, value: '180', locked: true}
- {id: SYSCON.CLKOUTSELA.sel, value: SYSCON.MAINCLKSELB}
...
void BOARD_BootClockPLL180M(void)
{
    ...
    CLOCK_SetClkDiv(kCLOCK_DivClkOut, 180U, false);                  /*!< Set CLKOUTDIV divider to value 180 */
...
- {id: System_clock.outFreq, value: 110 MHz}
...
void BOARD_BootClockPLL220M(void)
{
    ...
    /*!< Need to make sure ROM and OTP has power(PDRUNCFG0[17,29]= 0U) 
         before calling this API since this API is implemented in ROM code */
    CLOCK_SetupFROClocking(12000000U);                    /*!< Set up FRO to the 12 MHz, just for sure */
    POWER_SetVoltageForFreq(110000000U);             /*!< Set voltage for the one of the fastest clock outputs: System clock output */
    CLOCK_SetFLASHAccessCyclesForFreq(110000000U);    /*!< Set FLASH wait states for core */
